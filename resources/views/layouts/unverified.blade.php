       ...
       <tbody>
          <tr>
             <td style="	font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
                ...
                ">
                <img src="https://www.jamstockex.com/wp-content/uploads/2014/09/logo.png" class="carpool_logo" width="232" style="	display: block;
                   margin: 0 auto;
                   margin: 30px auto;">
             </td>
          </tr>
                   ...
                   <tbody>
                      <tr>
                         <td class="section_content_padded" style="	font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
                            ...
                            <p class="near_title last" style="margin-top: 10px;margin-bottom: 0;">Please verify that your email address is {{Auth::user()->email}}, and that you entered it when signing up for JSE DMA Broker.</p>
                             {{-- @if(Auth::user()->roles[0]->name === "ADMB")  --}}
                            <a href="/jse-validation/{{Auth::user()->hash}}/accept" style="	display: block;
                               width: 100%;
                               max-width: 300px;
                               background: #3eaeef;
                               border-radius: 8px;
          ...
          <tr>
             <td style="	font-family: -apple-system, BlinkMacSystemFont, Roboto, sans-serif;
                ...
                <p class="footer_legal" style="	padding: 20px 0 40px;
                   ...
                   line-height: 1.5;
                   ">
                   If you did not enter this email address when signing up for JSE DMA Broker service, disregard this message.<br><br>
