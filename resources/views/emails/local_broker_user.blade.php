...
<head>
    ...
    <a href="http://100.24.69.39/verify-broker-user/{{$user['id']}}/accept">Confirm Request </a><br>
    <a href="http://100.24.69.39/verify-broker-user/{{$user['id']}}/reject">Deny Request </a><br>
